...
class TestMwsDELETE(FlaskMuxBaseTest):
    def setUp(self):
        ...
        self.req_func = self.client.patch

    def test_basic(self):
        """test PATCH method with no middlewares"""
        resp = self.req_func('/basic')
        self.assertEqual(resp.status_code, 200)

    def test_one_mw(self):
        """test PATCH method with one middleware"""
        body = {'message': 'samcro'}
    ...
    def test_multi_mws(self):
        """test PATCH method with multiple middleware"""
        body = {'message': 'samcro'}
    ...
    def test_extra_mws(self):
        """test PATCH method with many middleware"""
        body = {'message': 'samcro'}
